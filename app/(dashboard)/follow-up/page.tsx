    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#387146] text-white">
            <ClipboardList className="h-5 w-5" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Follow-up de Solicitações</h1>
            <p className="text-sm text-slate-500">Acompanhe solicitações, pedidos de compra e recebimentos</p>
          </div>
        </div>
        <Button
          onClick={() => {

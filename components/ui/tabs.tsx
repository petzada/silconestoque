  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "text-muted-foreground hover:text-foreground relative inline-flex h-full flex-1 items-center justify-center gap-2 border border-transparent bg-transparent px-4 text-sm font-normal whitespace-nowrap transition-colors outline-none focus-visible:shadow-[inset_0_0_0_2px_var(--ring)] group-data-[orientation=vertical]/tabs:w-full group-data-[orientation=vertical]/tabs:justify-start disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
